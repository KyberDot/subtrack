      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              ...
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={catData} layout="vertical" margin={{ left: 0, right: 10 }}>
                  ...
                  <Tooltip
                    ...
                    cursor={false}
                  />
                  <Bar dataKey="spend" radius={[0, 4, 4, 0]} isAnimationActive={false} activeBar={false}>
        ...
        <div className="card" style={{ overflow: "hidden" }}>
          ...
          {catData.length === 0
            ...
            : (
              <>
                <div style={{ display: "flex", justifyContent: "center", position: "relative", padding: "8px 0 12px" }}>
                  <ResponsiveContainer width={160} height={160}>
                    <PieChart>
                      <Pie data={catData} dataKey="spend" cx="50%" cy="50%" innerRadius={44} outerRadius={72} paddingAngle={2}>
                        {catData.map((c, i) => <Cell key={i} fill={c.color} />)}
                      </Pie>
                      <Tooltip
                  ...
                  <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", textAlign: "center", pointerEvents: "none" }}>
                    <div style={{ fontSize: 12, fontWeight: 800 }}>{currencySymbol}{fmt(monthlyTotal)}</div>
                    <div style={{ fontSize: 9, color: "var(--muted)" }}>/mo</div>
                  </div>
                </div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6px 12px", padding: "4px 2px" }}>
