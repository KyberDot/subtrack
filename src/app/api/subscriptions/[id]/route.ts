...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const fields = [
    "name", "amount", "currency", "cycle", "category", "icon", "color",
    "next_date", "member_id", "notes", "trial", "active", "payment_method_id",
    "type", "remind_1d", "remind_3d", "remind_7d", "remind_14d", "direct_debit",
  ];
